...
<main class="container">
  <div class="card security">
    <form:form modelAttribute="signupRequest" action="/admin/signup" method="post" id="signupRequest">
      <div class="mb-4">
      ...
      <div class="button-container">
        <button type="submit" name="action" class="btn btn-dark w-50">등록</button>
      </div>
    </form:form>
  </div>
</main>
